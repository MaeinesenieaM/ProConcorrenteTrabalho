            ...
            for tipo, valores in current_requests.items():
                for valor in valores:
                    match tipo:
                        case "reservar":
                            ...
                            if assento in self.assentos:
                                ...
                                if self.assentos[assento] is None:
                                    ...
                                    resposta = f"[SERVER] Assento {assento} reservado com sucesso por {nome}."
                                else:
                        ...
                        case "listar":
                            nome = valor
                            self.clients[nome].add_response("assentos", self.assentos)
...
class Cliente:
    ...
    def reservar(self, assento):
        ...
        if resposta is None:
            print("RESERVA COM ASSENTO INVALIDO!")
        else:
            print(resposta)
    ...
    def listar_assentos(self):
        ...
        if assentos is None:
            print("TODO!")
        self.imprimir_assentos(assentos)
    ...
    def imprimir_assentos(self, assentos):
